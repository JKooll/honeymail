...
//纪念日
let startDay = "2022/4/4";
//当地拼音,需要在下面的墨迹天气url确认
const local = "shanghai/shanghai";

//发送者邮箱厂家
let EmianService = "smtp.163.com";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "jkooll@163.com",
  pass: "BWMALTECYOLIDDWT"
};
//发送者昵称与邮箱地址
let EmailFrom = '"❤️" <jkooll@163.com>';

//接收者邮箱地
//let EmailTo = "2037391705@qq.com";
let EmailTo = "2870825294@qq.com";
//邮件主题
